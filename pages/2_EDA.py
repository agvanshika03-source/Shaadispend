...
with c3:
    ...
    fig3.add_hrule(y=50, line_dash='dash', line_color='gray', annotation_text='50% threshold')
...
fig7=px.scatter(samp,x='Income_num',y='Budget_num',color='City_tier',trendline='ols',
