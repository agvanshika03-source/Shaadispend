...
pages = [
    ...
    ("🧹","8 — Data Cleaning Report","Before/After comparison · Issue audit · Feature engineering log","Mark 2 — Data Prep"),
    ("✅","9 — Business Validation","Scorecard · Revenue projection · Risk matrix · Market sizing","Mark 1 — Validation"),
    ("📉","10 — Cohort Analysis","8 cross-tab heatmaps · Income×City · Age×WTP · State bubbles","Mark 3 — EDA"),
    ("🎛️","11 — Budget Simulator","What-if sliders · Scenario analysis · Personalised tips","Mark 3 — Regression"),
]
cols = st.columns(3)
